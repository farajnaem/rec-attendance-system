<?php $title = 'الاستعارة المؤقتة للموظفين'; ?>
<h1>الاستعارة المؤقتة</h1>
<p class="text-muted">
...
<div class="card" id="addBorrowPanel" hidden>
    <h2>استعارة موظف</h2>
    <form method="post" action="<?= e(url('/manager/borrow-employee/create')) ?>">
        ...
        <div class="grid-2">
            ...
            <div class="form-group">
                <label>الدائرة المستهدفة (دائرتك) *</label>
...
<div class="card">
    ...
    <table>
        ...
        <tr>
            ...
            <td><?= e($c['end_date'] ?? '—') ?></td>
            <td>
                <form method="post" action="<?= e(url('/manager/borrow-employee/end')) ?>" style="display:inline"
                      onsubmit="return confirm('إنهاء الاستعارة؟');">
                    <?= Csrf::field() ?>
